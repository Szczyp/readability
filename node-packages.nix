...
let
  sources = {
    ...
    "readability-git://github.com/mozilla/readability" = {
      name = "readability";
      packageName = "readability";
      version = "0.2.0";
      src = fetchgit {
        url = "git://github.com/mozilla/readability";
        rev = "2982216913af2c66b0690e88606b03116553ad92";
        sha256 = "9da9554f1f9b7be036cefcee3d9ecc4012f3b00361172597cef8359642fcf334";
      };
    };
    "request-2.88.0" = {
      name = "request";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."qs-6.5.2"
      sources."readability-git://github.com/mozilla/readability"
